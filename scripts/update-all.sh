...
########################################################################################################
# Requirements:
# Place this script in /home/pi/klipper_config/scripts
# make this bash script file executable (update-all.sh):
# sudo chmod +x /home/pi/klipper_config/scripts/update-all.sh
#
...
# cd /home/pi/klipper_config/scripts
# ./update-all.sh 
#
...
# cd ~/klipper && make flash KCONFIG_CONFIG=/home/pi/klipper_config/scripts/<config.you_name_your_file> FLASH_DEVICE=0483:df11 (or the ID that shows up on the lsusb command)
#
# ---------------------------------------------------------------
#
#  [mcu]
...
#  cat ~/klipper/config.octopus-pro-f446
#
#  cd ~/klipper
...
make clean 
make menuconfig KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.octopus-pro-f446
make -j4 KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.octopus-pro-f446
...
make flash KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.octopus-pro-f446 FLASH_DEVICE=/dev/serial/by-id/usb-Klipper_stm32f446xx_0F003E00095053424E363420-if00
...
# lsusb 
#    Bus 001 Device 030: ID 0483:df11 STMicroelectronics STM Device in DFU Mode
# make flash KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.octopus-pro-f446 FLASH_DEVICE=0483:df11
...
make clean 
make menuconfig KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.ebb36v1.2
make -j4 KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.ebb36v1.2
...
#make flash KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.CanBoot.rp2040 FLASH_DEVICE="2e8a:0003" 
...
make clean 
make menuconfig KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.rp240_withBootloader
make -j4 KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.rp240_withBootloader
...
make flash KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.rp240_withBootloader FLASH_DEVICE=/dev/serial/by-id/usb-Klipper_rp2040_E0C9125B0D9B-if00
...
make clean 
make menuconfig KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.rpi
make -j4 KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.rpi
...
make flash KCONFIG_CONFIG=/home/pi/klipper_config/scripts/config.rpi
