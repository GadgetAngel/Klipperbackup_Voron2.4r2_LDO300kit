...
class SettlingProbe(probe.PrinterProbe):
    ...
    def handle_ready(self):
        if self.settling_sample:
            self.settling_sample = 1
        else:
            self.settling_sample = 0
    ...
    def cmd_PROBE(self, gcmd):
        self.settling_sample = gcmd.get_int("SETTLING_SAMPLE", self.settling_sample)
        return probe.PrinterProbe.cmd_PROBE(self, gcmd) 
    ...
    def cmd_PROBE_CALIBRATE(self, gcmd):
        self.settling_sample = gcmd.get_int("SETTLING_SAMPLE", self.settling_sample)
        return probe.PrinterProbe.cmd_PROBE_CALIBRATE(self, gcmd)
